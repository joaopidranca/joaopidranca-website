...
!(function (a, b) {
    ...
    function c(a, c) {
        ...
        if (((t += 'position: fixed; top: 0%; left: 0%; content: ""; height: 100%; opacity: 0.5; width: 100%; animation-name: grained; animation-iteration-count: infinite; animation-duration: 0.5s; animation-timing-function: steps(20); background-color: #0dcaf0; z-index: 10000;'), (n = h.length), i.animate))
            for (; n--; )
